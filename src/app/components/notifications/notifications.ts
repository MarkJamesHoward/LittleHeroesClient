...
export class notifications {
    ...
    async subscribe() {
        ...
        if ('serviceWorker' in navigator) {
            ...
            const applicationServerPublicKey = 'BPuzIwehJRwG6w26oLqlW9PPKWAom9W6y5BRQJTaehH7LecpzIwIIk5Ru1Emt_P92BORv60yOkJdxCxcXixWrJE';
            ...
            let result = await this.http.fetch(`/api/push/${this.friendlyName}`, { method: 'post', credentials: 'same-origin', body: json(subscribeResult)});
